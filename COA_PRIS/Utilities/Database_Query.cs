...
namespace COA_PRIS
{
    internal class Database_Query
    {
        ...
        public static readonly string get_general_project_records_by_date = "SELECT docu_info_table.code, docu_info_table.document_no, CONCAT(\"₱ \", FORMAT(docu_info_table.amount,2)) AS amount, DATE_FORMAT(docu_info_table.period, \"%M %Y\") AS period, docu_info_table.subject FROM docu_info_table WHERE {0} BETWEEN '{1}' AND '{2}'";
        ...
        public static readonly string get_specific_project_records_by_date2 = "SELECT docu_info_table.code, docu_info_table.document_no, CONCAT(\"₱ \", FORMAT(docu_info_table.amount,2)) AS amount, DATE_FORMAT(docu_info_table.period, \"%M %Y\") As period, docu_info_table.subject FROM docu_info_table WHERE {0} BETWEEN '{1}' AND '{2}' AND (document_id LIKE '%{3}%' OR \r" +
        ...
        public static readonly string get_employee_options = "SELECT emp_info_table.code, emp_info_table.full_name, emp_info_table.email FROM emp_info_table WHERE emp_info_table.status != 0 AND -2";
